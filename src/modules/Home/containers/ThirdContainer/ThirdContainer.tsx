...
const ThirdContainer = () => {
  return (
    <div className="third-container">
      <Container>
        <Row>
          <Col sm="12" md="6" className="cont-flag relative">
            <div className="gsap-flag">
              <div>
          ...
          <Col sm="12" md="6" className="text-info relative">
            <div className="gsap-polizas">
              <Title
              ...
              <p>
                Estamos dispuestos a explicarte hasta que no queden dudas para
                que contrates tu seguro con toda la información que necesites,
                lo que más nos importa es que no gastes altas cantidades de
                dinero en licenciados, ni en pagar los daños a los carros de
                otras personas.
              </p>
            </div>
          </Col>
